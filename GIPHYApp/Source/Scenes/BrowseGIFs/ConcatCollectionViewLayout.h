...
@protocol ConcatCollectionViewLayoutDelegate<NSObject>

@optional

- (UIEdgeInsets)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout edgeInsetForSectionAtIndex:(NSInteger)section;
...
@interface ConcatCollectionViewLayout : UICollectionViewLayout
...
@property (nonatomic, weak) id<ConcatCollectionViewLayoutDelegate> delegate;
